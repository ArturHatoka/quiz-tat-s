...
FE_F.prototype.run = function (eventName, event, target) {
    ...
    for (var i in this.h[eventName] || []) {
        if (!this.h[eventName].hasOwnProperty(i)) {
            continue;
        }
